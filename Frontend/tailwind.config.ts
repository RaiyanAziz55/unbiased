  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        spectrum: {
          "far-left": "hsl(var(--spectrum-far-left))",
          "left": "hsl(var(--spectrum-left))",
          "center-left": "hsl(var(--spectrum-center-left))",
          "center": "hsl(var(--spectrum-center))",
          "center-right": "hsl(var(--spectrum-center-right))",
          "right": "hsl(var(--spectrum-right))",
          "far-right": "hsl(var(--spectrum-far-right))",
        },
        confidence: {
